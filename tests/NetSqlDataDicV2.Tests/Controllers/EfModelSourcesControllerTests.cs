...
public class EfModelSourcesControllerTests
{
    ...
    public void DiscoverDbContexts_Success_ReturnsJsonWithDbContexts()
    {
        ...
        var request = new EfModelSourcesController.DiscoverRequest { AssemblyPath = "/path/to/test.dll" };
    ...
    {
        // Arrange
        var request = new EfModelSourcesController.DiscoverRequest { AssemblyPath = null };
